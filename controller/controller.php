...
<div class="container">
    ...
    <form class="form-horizontal"  method="post"  action="run.php">
        ...
        <fieldset>
            ...
            <!-- Multiple Checkboxes -->
            <div class="form-group">
                <label class="col-md-4 control-label" for="repositoryExceptions">Controller</label>
                <div class="col-md-4">
                    <div class="checkbox">
                        <label for="repositoryExceptions-1">
                            <input type="checkbox" checked name="controller[controller]" id="controller-1" value="controller">
                            Collection
                        </label>
                    </div>
