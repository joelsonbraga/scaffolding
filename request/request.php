...
<div class="container">
    ...
    <form class="form-horizontal"  method="post"  action="run.php">
        ...
        <fieldset>
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="repositoryExceptions">Request</label>
                <div class="col-md-4">
                    <div class="checkbox">
                        <label for="repositoryExceptions-0">
                            <input type="checkbox" checked name="requests[update]" id="requests-0" value="update">
                            Collection
                        </label>
                    </div>
                    <div class="checkbox">
                        <label for="repositoryExceptions-1">
                            <input type="checkbox" checked name="requests[update]" id="requests-1" value="store">
                            Resources
                        </label>
                    </div>
